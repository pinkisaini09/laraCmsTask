...
Route::group(['prefix' => ''], function () {
    ...
    Route::get('contacts-us', [ContactsController::class, 'contactsUs'])->name('contacts.us');
    Route::post('contacts-store', [ContactsController::class, 'contactStore'])->name('contacts.store');
});
